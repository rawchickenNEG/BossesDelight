package io.github.rcneg.bossesdelight.recipes;

import com.google.gson.JsonArray;
import com.google.gson.JsonObject;
import com.google.gson.JsonParseException;
import io.github.rcneg.bossesdelight.client.recipebook.SoulCookingPotRecipeBookTab;
import io.github.rcneg.bossesdelight.init.ItemRegistry;
import io.github.rcneg.bossesdelight.init.RecipeSerializersRegistry;
...
public class SoulCookingPotRecipe implements Recipe<RecipeWrapper> {
    ...
    private final SoulCookingPotRecipeBookTab tab;
    ...
    public SoulCookingPotRecipe(ResourceLocation id, String group, @Nullable SoulCookingPotRecipeBookTab tab, NonNullList<Ingredient> inputItems, ItemStack output, ItemStack container, float experience, int cookTime) {
        this.id = id;
        this.group = group;
        this.tab = tab;
    ...
    @Nullable
    public SoulCookingPotRecipeBookTab getRecipeBookTab() {
        return this.tab;
    }
    ...
    public RecipeSerializer<?> getSerializer() {
        return RecipeSerializersRegistry.COOKING.get();
    }

    @Override
    public RecipeType<?> getType() {
        return RecipeTypesRegistry.SOUL_COOKING.get();
    }

    public ItemStack getToastSymbol() {
        return new ItemStack((ItemLike) ItemRegistry.SOUL_COOKING_POT_ITEM.get());
    }
    ...
    public static class Serializer implements RecipeSerializer<SoulCookingPotRecipe> {
        ...
        public SoulCookingPotRecipe fromJson(ResourceLocation recipeId, JsonObject json) {
            ...
            if (inputItemsIn.isEmpty()) {
                ...
                SoulCookingPotRecipeBookTab tabIn = SoulCookingPotRecipeBookTab.findByName(tabKeyIn);
                if (tabKeyIn != null && tabIn == null) {
                    FarmersDelight.LOGGER.warn("Optional field 'recipe_book_tab' does not match any valid tab. If defined, must be one of the following: " + EnumSet.allOf(SoulCookingPotRecipeBookTab.class));
                }
                ...
                return new SoulCookingPotRecipe(recipeId, groupIn, tabIn, inputItemsIn, outputIn, container, experienceIn, cookTimeIn);
            }
        }
        ...
        @Nullable
        public SoulCookingPotRecipe fromNetwork(ResourceLocation recipeId, FriendlyByteBuf buffer) {
            String groupIn = buffer.readUtf();
            SoulCookingPotRecipeBookTab tabIn = SoulCookingPotRecipeBookTab.findByName(buffer.readUtf());
        ...
        public void toNetwork(FriendlyByteBuf buffer, SoulCookingPotRecipe recipe) {
