...
public class ItemRegistry {
    ...
    public static final RegistryObject<Item> BROKEN_OBSIDIAN_HEART = ITEMS.register("broken_obsidian_heart", () -> new Item(defaultBuilder()
            .food((new FoodProperties.Builder()).nutrition(4).saturationMod(1.0f)
                    ...
                    .build())));
    public static final RegistryObject<Item> OBSIDIAN_SAUCE = ITEMS.register("obsidian_sauce", () -> new BowlFoodItem(bowlFoodBuilder()
    ...
    public static final RegistryObject<Item> OBSIDIAN_ONION = ITEMS.register("obsidian_onion", () -> new TippedBlockItems(BlockRegistry.OBSIDIAN_ONION_BLOCK.get(),defaultBuilder()
            .food((new FoodProperties.Builder()).nutrition(6).saturationMod(0.8f)
                    ...
                    .build())));
    public static final RegistryObject<Item> OBSIDIAN_RUNE_PUREE = ITEMS.register("obsidian_rune_puree", () -> new Item(defaultBuilder()
            .food((new FoodProperties.Builder()).nutrition(10).saturationMod(1.2f).alwaysEat()
                    ...
                    .build())));
    public static final RegistryObject<Item> OBSIDIAN_RUNE_COCKTAIL = ITEMS.register("obsidian_rune_cocktail", () -> new Item(defaultBuilder()
            .food((new FoodProperties.Builder()).nutrition(6).saturationMod(1.0f).alwaysEat()
                    ...
                    .build())));
    public static final RegistryObject<Item> OBSIDIAN_GLAZED_DRAGON_HEAD = ITEMS.register("obsidian_glazed_dragon_head_block", () -> {
        return new BlockItem(BlockRegistry.OBSIDIAN_GLAZED_DRAGON_HEAD_BLOCK.get(), defaultBuilder().stacksTo(1));
    });
    public static final RegistryObject<Item> BOWL_OF_OBSIDIAN_GLAZED_DRAGON_HEAD = ITEMS.register("bowl_of_obsidian_glazed_dragon_head", () -> new BowlFoodItem(bowlFoodBuilder()
            .food((new FoodProperties.Builder()).nutrition(16).saturationMod(1.1f).alwaysEat()
                    ...
                    .build())));
    public static final RegistryObject<Item> CRYSTAL_FRUIT_SLICE = ITEMS.register("crystal_fruit_slice", () -> new Item(defaultBuilder()
    ...
    public static final RegistryObject<Item> CRYSTAL_CUP_CAKE = ITEMS.register("crystal_cup_cake", () -> new Item(defaultBuilder()
            .food((new FoodProperties.Builder()).nutrition(8).saturationMod(2.0f).alwaysEat()
                    ...
                    .build())));
    public static final RegistryObject<Item> BLOSSOM_SALAD = ITEMS.register("blossom_salad", () -> new Item(defaultBuilder()
    ...
    public static final RegistryObject<Item> BOWL_OF_CRYSTAL_FRUIT_CUBE = ITEMS.register("bowl_of_crystal_fruit_cube", () -> new BowlFoodItem(bowlFoodBuilder()
    ...
    public static final RegistryObject<Item> BLAZING_EYE_SHARDS = ITEMS.register("blazing_eye_shards", () -> new Item(defaultBuilder()
            .food((new FoodProperties.Builder()).nutrition(4).saturationMod(1.0f)
                    ...
                    .build())));
    public static final RegistryObject<Item> ANCIENT_ROLL = ITEMS.register("ancient_roll", () -> new Item(defaultBuilder()
            .food((new FoodProperties.Builder()).fast().nutrition(6).saturationMod(1.2f)
                    .effect(new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 400, 3), 0.6F)
                    .build())));
    ...
    public static final RegistryObject<Item> BLAZING_EYE_PIE_SLICE = ITEMS.register("blazing_eye_pie_slice", () -> new Item(defaultBuilder()
    ...
    public static final RegistryObject<Item> BOWL_OF_HAM_ABOVE_PALM = ITEMS.register("bowl_of_ham_above_palm", () -> new BowlFoodItem(bowlFoodBuilder()
    ...
    public static final RegistryObject<Item> ANIMA_POPSICLE = ITEMS.register("anima_popsicle", () -> new BowlFoodItem(bowlFoodBuilder()
    ...
    public static final RegistryObject<Item> BOWL_OF_LICH_SMOOTHIES = ITEMS.register("bowl_of_lich_smoothies", () -> new BowlFoodItem(bowlFoodBuilder()
            .food((new FoodProperties.Builder()).nutrition(12).saturationMod(1.2f).alwaysEat()
    ...
    public static final RegistryObject<Item> BOWL_OF_MAGIC_FROZEN_NOODLES = ITEMS.register("bowl_of_magic_frozen_noodles", () -> new BowlFoodItem(bowlFoodBuilder()
            .food((new FoodProperties.Builder()).nutrition(12).saturationMod(1.2f).alwaysEat()
                    .effect(new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 6000, 1), 1.0F)
                    .effect(new MobEffectInstance(MobEffects.NIGHT_VISION, 6000, 0), 1.0F)
                    .effect(new MobEffectInstance(EffectRegistry.INTANGIBLE.get(), 1200, 1), 1.0F)
                    .build())));
    public static final RegistryObject<Item> BOSSES_HODGEPODGE = ITEMS.register("bosses_hodgepodge", () -> new BowlFoodItem(bowlFoodBuilder()
